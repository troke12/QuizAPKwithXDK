...
DG.QuizMaker = new Class( {
	...
	_addAnswerButton : function() {
		var el = new Element('div');
		el.addClass('btn  pull-right');
		el.set('html',"<button class='btn btn-success pull-right green-btn'>Jawab</Button></br></br>");
		el.addEvent('click', this._sendAnswer.bind(this));
		document.id(this.html.el).adopt(el);
	},
